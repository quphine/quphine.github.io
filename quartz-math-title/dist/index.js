...
function renderMathTitle(raw) {
  ...
  while ((match = mathPattern.exec(raw)) !== null) {
    ...
    const isDisplay = displayMath !== void 0;
...
// src/index.tsx
var MathArticleTitle = () => {
  const Component = ({ fileData }) => {
    const title = fileData.frontmatter?.title ?? fileData.slug ?? "";
    return /* @__PURE__ */ u2("h1", { dangerouslySetInnerHTML: { __html: renderMathTitle(title) } });
  };
  return Component;
};
var src_default = MathArticleTitle;
